...
public class ZEDPlaneDetectionManager : MonoBehaviour
{
    ...
    // #### flag Plane Detection Enable
    [SerializeField]
    private bool isEnablePlaneDetection = false;

    // #### flag Plane Detection Enable get set.
    public bool EnablePlaneDetection
    {
        get
        {
            return isEnablePlaneDetection;
        }
        set
        {
            if(value != isEnablePlaneDetection)
            {
                isEnablePlaneDetection = value;
            }
        }
    }
    ...
    public bool DetectFloorPlane(ZEDManager manager, bool auto)
    {
        ...
        if(false == isEnablePlaneDetection)
            return false;
...
public class ZEDPlaneDetectionEditor : Editor
{
    ...
    // #### Plane Deteciton Manager 의 기능 활성화 플래그
    private SerializedProperty isEnablePlaneDetection;
    ...
    public void OnEnable()
    {
        ...
        isEnablePlaneDetection = serializedObject.FindProperty("isEnablePlaneDetection");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUIContent enableplanedetectionlabel = new GUIContent("Enable PlaneDetection", "enable ZEDPlaneDetection");    // #### ZEDPlaneDetection Enable Label.
        ...
        isEnablePlaneDetection.boolValue = EditorGUILayout.Toggle(enableplanedetectionlabel, isEnablePlaneDetection.boolValue);  // #### Enable PlaneDetection boolValue.
